...
<head>
		<title>Defaulters by Centre and Age</title>
...
<font size= 3 >Report of Defaulters by centre and Age</font>
<br>
<br>
<br>
<center>
...
<th colspan=2 rowspan=2><center><font size= 3 bold>Centre</font></center></th><th colspan=5 width=60%><center><font size= 3 bold>Age Group</font></center></th><th rowspan=2 width=20%><center><font size= 3 bold>Total</font></center></th></tr>
...
{% php while($row_list1=mysql_fetch_array($q1)){$q2 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where asthma_app_patients.Age<15 and asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK and asthma_app_patients.Centre_ID_id=".$row_list1[0]);$q3 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where (asthma_app_patients.Age between 14 and 25) and asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK and asthma_app_patients.Centre_ID_id=".$row_list1[0]);  $q4 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where (asthma_app_patients.Age between 24 and 45) and asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK and asthma_app_patients.Centre_ID_id=".$row_list1[0]);  $q5 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where (asthma_app_patients.Age between 44 and 65) and asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK and asthma_app_patients.Centre_ID_id=".$row_list1[0]);  $q6 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where asthma_app_patients.Age>=65 and asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK and asthma_app_patients.Centre_ID_id=".$row_list1[0]);$q7 = mysql_query("select count(*) from asthma_app_patients where Age<15 and Centre_ID_id=".$row_list1[0]);  $q8 = mysql_query("select count(*) from asthma_app_patients where Age between 14 and 25 and Centre_ID_id=".$row_list1[0]);  $q9 = mysql_query("select count(*) from asthma_app_patients where Age between 24 and 45 and Centre_ID_id=".$row_list1[0]);  $q10 = mysql_query("select count(*) from asthma_app_patients where Age between 44 and 65 and Centre_ID_id=".$row_list1[0]);  $q11 = mysql_query("select count(*) from asthma_app_patients where Age>=65 and Centre_ID_id=".$row_list1[0]); %}
