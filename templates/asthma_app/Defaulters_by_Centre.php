...
<head>
		<title>Defaulter by center</title>
...
<font size= 3 >Report of Defaulters by centre</font>
<br>
<br>
<br>
<center>
<table  border=1 cellpadding=10 width=100%>
<tr bgcolor=#C0C0C0 id=f><th width=25%><center><font size= 3 bold>Centre</font></center></th><th width=25%><center><font size= 3 bold>Defaulters</font></center></th><th width=25%><center><font size= 3 bold>Total</font></center></th><th width=25%><center><font size= 3 bold>Percentage</font></center></th></tr>

{% php  $q1 = mysql_query("select distinct Centre_Name from asthma_app_centres");$q2 = mysql_query("select count(*) from asthma_app_defaulter,asthma_app_patients where asthma_app_defaulter.Defaulter_ID = asthma_app_patients.Patients_PK group by asthma_app_patients.Centre_ID_id");$q3 = mysql_query("select count(*) from asthma_app_patients group by Centre_ID_id"); %}
{% php  while($row_list1=mysql_fetch_array($q1) and  $row_list2=mysql_fetch_array($q2) and $row_list3=mysql_fetch_array($q3) ){ %}
{% php echo "<tr><td>".$row_list1[0]."</td>"."<td>".$row_list2[0]."</td>"."<td>".$row_list3[0]."</td><td>".round(($row_list2[0]/$row_list3[0]*100),2)." %</td></tr>"; } %}
