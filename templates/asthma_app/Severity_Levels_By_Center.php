...
<input type="radio" name="CB" value="a" id="by_center" checked/>By Center&nbsp;&nbsp;
...
<br>
<font size= 3 >Report of severity level by centre </font>
<br>
<br>
<br>
<center>
...
<tr bgcolor=#C0C0C0 id=f><th width=25%><center><font size= 3 bold>Centre</font></center></th><th width=25%><center><font size= 3 bold>Severe</font></center></th><th width=25%><center><font size= 3 bold>Moderate</font></center></th><th width=25%><center><font size= 3 bold>Mild</font></center></th></tr>
{% php $q1=mysql_query("select distinct Centre_ID,Centre_Name from asthma_app_centres"); %}
{% php while($row_list1=mysql_fetch_array($q1)){$q2=mysql_query("select count(*) from asthma_app_asthma_mgmt, asthma_app_patients where asthma_app_asthma_mgmt.Asthma_Mgmt_PK = asthma_app_patients.Patients_PK and asthma_app_asthma_mgmt.Severity_Level_id = 1 and  asthma_app_patients.Centre_ID_id={$row_list1[0]}");$q3 = mysql_query("select count(*) from asthma_app_followup_visits, asthma_app_patients where asthma_app_followup_visits.Follow_Visits = asthma_app_patients.Patients_PK and asthma_app_followup_visits.F_Severity_Level_id = 1 and month(asthma_app_followup_visits.Follow_Date) = 2 and asthma_app_patients.Centre_ID_id={$row_list1[0]}");$q4 = mysql_query("select count(*) from asthma_app_asthma_mgmt, asthma_app_patients where asthma_app_asthma_mgmt.Asthma_Mgmt_PK = asthma_app_patients.Patients_PK and asthma_app_asthma_mgmt.Severity_Level_id = 2 and  asthma_app_patients.Centre_ID_id={$row_list1[0]}");$q5 = mysql_query("select count(*) from asthma_app_followup_visits, asthma_app_patients where asthma_app_followup_visits.Follow_Visits = asthma_app_patients.Patients_PK and asthma_app_followup_visits.F_Severity_Level_id = 2 and month(asthma_app_followup_visits.Follow_Date) = 2 and asthma_app_patients.Centre_ID_id={$row_list1[0]}");$q6 = mysql_query("select count(*) from asthma_app_asthma_mgmt, asthma_app_patients where asthma_app_asthma_mgmt.Asthma_Mgmt_PK = asthma_app_patients.Patients_PK and asthma_app_asthma_mgmt.Severity_Level_id = 3 and  asthma_app_patients.Centre_ID_id={$row_list1[0]}");$q7 = mysql_query("select count(*) from asthma_app_followup_visits, asthma_app_patients where asthma_app_followup_visits.Follow_Visits = asthma_app_patients.Patients_PK and asthma_app_followup_visits.F_Severity_Level_id = 3 and month(asthma_app_followup_visits.Follow_Date) = 2 and asthma_app_patients.Centre_ID_id={$row_list1[0]}"); %}
...
{% php echo "<tr><td>".$row_list1[1]."</td><td>".($row_list2[0]+$row_list22[0])."</td><td>".($row_list3[0]+$row_list33[0])."</td><td>".($row_list4[0]+$row_list44[0])."</td></tr>";} %}
</table></center>
