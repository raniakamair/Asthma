...
DATABASES = {
    "default": {
        ...
        'NAME': 'asthma',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'romo',                  # Not used with sqlite3.
...
RAPIDSMS_TABS = [
 ...
 ("asthma.apps.asthma_app.views.Home",    "Home"),
    ("asthma.apps.asthma_app.views.Message_log",    "Message Log"),   
    ("asthma.apps.asthma_app.views.Defaulters",    "Defaulters Report"),
    ("asthma.apps.asthma_app.views.Severity_Levels",    "Severity Levels Report"),
    ("asthma.apps.asthma_app.views.ER_and_Hospital",    "ER and Hospital Report"),
